...
initAcct(account.st, portfolios = portfolio.st, initEq = 1000000, initDate = "1999-12-31")
...
for (sym in symbol){
addPosLimit(strat, sym, timestamp="1999-12-31", maxpos=100, 
...
chart.Posn(Portfolio = portfolio.st, Symbol = "CO", TA="add_BBands(n=20,sd=2)")          # Chart the position
